...
<style>
/* hide title */
article > main > div.content > :nth-child(1) {
    display: none;
}
</style>

{{< carousel gallery="kevinbot-core" >}}

{{< hextra/hero-button text="View Project on GitHub" link="https://github.com/meowmeowahr/KevinbotV3-KiCAD/tree/RevB" >}}
